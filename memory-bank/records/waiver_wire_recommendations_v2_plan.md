# Waiver Wire Recommendations v2 — GO-FORWARD (Superseded by v3)

Note: See the consolidated and up‑to‑date plan in
`memory-bank/waiver_wire_recommendations_v3_plan.md`.
